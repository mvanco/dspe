...
int hookAll()
{
	...
	privateFiles.push_back(TaintedFile::create("/sdcard/mytest.txt"));

	return TRUE;
}

extern "C" {
JNIEXPORT jstring Java_com_rx201_apkmon_APIHook_WriteTest( JNIEnv* env, jclass thiz );
JNIEXPORT void    Java_com_rx201_apkmon_APIHook_Hook( JNIEnv* env, jclass thiz, jboolean bHasStrictMode );
JNIEXPORT void    Java_com_rx201_apkmon_APIHook_KillMe( JNIEnv* env, jclass thiz);

//PE new functions
JNIEXPORT jobjectArray    Java_com_rx201_apkmon_APIHook_GetTaintedFiles( JNIEnv* env, jclass thiz);
JNIEXPORT jint Java_com_rx201_apkmon_APIHook_GetRestrictionType( JNIEnv* env, jclass thiz);
JNIEXPORT jint Java_com_rx201_apkmon_APIHook_APIHook_GetRestrictionMethod( JNIEnv* env, jclass thiz);
JNIEXPORT void Java_com_rx201_apkmon_APIHook_APIHook_SetIncreasedThreatLevel( JNIEnv* env, jclass thiz, jint increased);
JNIEXPORT jboolean Java_com_rx201_apkmon_APIHook_APIHook_IsTaintedFile( JNIEnv* env, jclass thiz, jstring path );
}
...
JNIEXPORT jint Java_com_rx201_apkmon_APIHook_GetRestrictionMethod(JNIEnv* env, jclass thiz) {
	load_settings();
	jint ret = RESTRICTION_METHOD;
	return ret;
}

JNIEXPORT void Java_com_rx201_apkmon_APIHook_SetIncreasedThreatLevel( JNIEnv* env, jclass thiz, jint increased) {
	THREAT_LEVEL = increased;
}

JNIEXPORT jboolean Java_com_rx201_apkmon_APIHook_IsTaintedFile( JNIEnv* env, jclass thiz, jstring path ) {
	const char *file;
