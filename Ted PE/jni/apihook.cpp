...
extern "C" {
JNIEXPORT jstring Java_fr_xgouchet_apkmon_APIHook_WriteTest( JNIEnv* env, jclass thiz );
JNIEXPORT void    Java_fr_xgouchet_apkmon_APIHook_Hook( JNIEnv* env, jclass thiz, jboolean bHasStrictMode );
JNIEXPORT void    Java_fr_xgouchet_apkmon_APIHook_KillMe( JNIEnv* env, jclass thiz);
JNIEXPORT jobjectArray    Java_fr_xgouchet_apkmon_APIHook_GetTaintedFiles( JNIEnv* env, jclass thiz);
JNIEXPORT jint Java_fr_xgouchet_apkmon_APIHook_GetRestrictionType( JNIEnv* env, jclass thiz);
JNIEXPORT jint Java_fr_xgouchet_apkmon_APIHook_GetRestrictionMethod( JNIEnv* env, jclass thiz);
JNIEXPORT void Java_fr_xgouchet_apkmon_APIHook_SetIncreasedThreatLevel( JNIEnv* env, jclass thiz, jint increased);
JNIEXPORT jboolean Java_fr_xgouchet_apkmon_APIHook_IsTaintedFile( JNIEnv* env, jclass thiz, jstring path );
}
