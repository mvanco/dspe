...
import fr.xgouchet.apkmon.APIHook;

import fr.xgouchet.apkmon_demo.IMyService;
...
//			List<String> lps = lm.getAllProviders();
		    ...
		    intent = new Intent("fr.xgouchet.apkmon.ProximityAlert");     
		...
		case R.id.btnReflectionTest:
	    	...
	    	try {
				Class clsApiHook = Class.forName("fr.xgouchet.apkmon.APIHook");
		...
		case R.id.my_test:
			Toast.makeText(this, "Hura", 5000).show();
		}
		*/
