...
public class SharingDialogActivity extends Activity implements DialogInterface.OnClickListener, DialogInterface.OnDismissListener {
...
//        Log.i("apihook_Dialog", "User Consent" + CurUserRequest.getResultMessenger().toString());
		if (which == DialogInterface.BUTTON_NEUTRAL) // No button
