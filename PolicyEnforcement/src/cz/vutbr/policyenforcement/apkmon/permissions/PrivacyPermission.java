package cz.vutbr.policyenforcement.apkmon.permissions;
...
public class PrivacyPermission extends AurasiumPermission  implements Serializable {
	public enum PRIVACY_TYPE {PhoneNumber, IMEI, IMSI, Contact, GPS_Last, GPS_Proximity, Sharing};
	...
	public PrivacyPermission(PRIVACY_TYPE type)
	{
		...
		case GPS_Proximity : 
			...
			break;
		case Sharing :
			setDescription("Do you really want to allow access at your own risk?");
			break;
		default:
