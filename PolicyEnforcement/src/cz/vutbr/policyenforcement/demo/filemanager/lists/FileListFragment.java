...
import cz.vutbr.policyenforcement.demo.filemanager.FileHolderListAdapter;
import cz.vutbr.policyenforcement.demo.filemanager.compatibility.ActionbarRefreshHelper;
import cz.vutbr.policyenforcement.demo.filemanager.files.DirectoryContents;
import cz.vutbr.policyenforcement.demo.filemanager.files.DirectoryScanner;
...
import cz.vutbr.policyenforcement.demo.filemanager.util.MimeTypes;
...
public abstract class FileListFragment extends ListFragment {
	...
	public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        mClipboardAction.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((APIHook)getActivity().getApplication()).getCopyHelper().clear();
                updateClipboardInfo();
    ...
    public void updateClipboardInfo() {
        CopyHelper copyHelper = ((APIHook) getActivity().getApplication()).getCopyHelper();
