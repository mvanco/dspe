...
import cz.vutbr.policyenforcement.demo.filemanager.bookmarks.BookmarkListActivity;
...
import cz.vutbr.policyenforcement.demo.util.MenuIntentOptionsWithIcons;
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		if (itemId == R.id.menu_search) {
			...
			if (cursor != null && cursor.moveToFirst()) 
			{
				...
				Toast.makeText(getApplicationContext(), "Empty Content Provider.", Toast.LENGTH_SHORT).show();
