...
extern "C" {
JNIEXPORT void    Java_cz_vutbr_policyenforcement_apkmon_APIHook_saveDecisions( JNIEnv* env, jobject thiz, jstring path, jbyteArray data);
JNIEXPORT jbyteArray Java_cz_vutbr_policyenforcement_apkmon_APIHook_loadDecisions( JNIEnv* env, jobject thiz, jstring path);
}
