...
public class BookmarksProvider extends ContentProvider implements BaseColumns{
    ...
    public static final String PROVIDER_NAME = "cz.vutbr.policyenforcement.demo.filemanager.bookmarks";
    ...
    private static final String DATABASE_NAME = "cz.vutbr.policyenforcement.demo.filemanager";
