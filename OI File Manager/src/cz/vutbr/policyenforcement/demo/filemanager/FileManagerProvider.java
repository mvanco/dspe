...
import cz.vutbr.policyenforcement.demo.filemanager.util.MimeTypeParser;
...
public class FileManagerProvider extends ContentProvider {
	...
	public static final String FILE_PROVIDER_PREFIX = "content://cz.vutbr.policyenforcement.demo.filemanager";
	private static final String TAG = "FileManagerProvider";
	public static final String AUTHORITY = "cz.vutbr.policyenforcement.demo.filemanager";
